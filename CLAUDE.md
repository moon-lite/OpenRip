...
Open-source launch telemetry for Beyblade X winder launchers: XIAO ESP32-C3
+ TCRT5000 reading the launcher's factory encoder disc through its top-face
window (zero launcher modification), RPM over serial (M0) and later BLE.
